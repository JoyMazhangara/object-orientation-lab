...
let favoriteThings = {
  ...
  food: 'tacos',
  person: 'Jesus',
  book: 'Everyone Always by Bob Goff',
  movie: 'The Lion King',
  holiday: 'Christmas',
}
...
function greeting( obj ) {
  ...
  let {title, firstName, lastName} = obj2
...
let cat1 = new Cat('Ella', '2', 'orange')
...
let wiz1 = new Wizard('Harry', '24', 'Hair Loss Spell')
wiz1.castSpell()
...
let phone1 = new Phone('iphone','6',1,'red',400)
let phone2 = new Phone('iphone','7',2,'blue',500)
let phone3 = new Phone('iphone','11',1,'silver',900)
...
let myFirstVehicle = new Vehicle(4, 'red', 41000);
...
let myFirstMotorcycle = new Motorcycle(1,'black', 3000, 'Honda',true)
console.log(myFirstMotorcycle)
/*
  Call the move function on myFirstMotorcycle (don't forget the parameter)
*/
console.log(myFirstMotorcycle.move(4000))
/*
...
let myFirstBoat = new Boat(40, 'white', 4000, 'Shelby', 'yacht', false)
